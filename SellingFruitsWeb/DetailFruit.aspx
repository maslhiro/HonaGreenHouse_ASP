    ...
    <div class="container container-fruite">
        <div class="row"> 
            ...
            <div class="col-md-7 left-fruite">
               ...
               <div class="row">
                   <div class="col-md-12 color-titel-fruite">
                       <h1><asp:Label ID="lblTenTC" runat="server" Text=""></asp:Label></h1> 
                   </div>
                   <div class="col-md-12"> <h5><asp:Label ID="lblDonGia" runat="server" Text=""></asp:Label>đ</h5> </div>
                   <div class="col-md-12"> <span>Đơn vị tính: <asp:Label ID="lblDonViTinh" runat="server" Text=""></asp:Label> </span> </div>
                   <div class="col-md-12"> <h5>Yêu cầu đặc biệt </h5> </div>
                   <div class="col-md-12"> 
            ...
            <div class="col-md-12 top-caption">
                <span class="caption">MIÊU TẢ <br /></span>
